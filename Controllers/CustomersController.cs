...
namespace The_New_Paradise.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Customer_ID,Customer_Name,Customer_Gender,Customer_Phone,Customer_Address,Customer_Email")] Customer customer)
        {
        ...
        public ActionResult CustSignIn(Models.Customer obj)
        {
            ...
            else
            {
                ...
                {
                    Models.Customer admin = context.Customers.Where(u => u.Customer_Email == obj.Customer_Email && u.Customer_Password == obj.Customer_Password).FirstOrDefault();
                    if (admin != null)
                    {

                        Session["CustomerEmail"] = admin.Customer_Email;
